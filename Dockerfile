...
RUN mkdir -p /usr/share/fonts/truetype/canopypdffonts
COPY effra_rg.ttf /usr/share/fonts/truetype/canopypdffonts
COPY effra_md.ttf /usr/share/fonts/truetype/canopypdffonts
RUN chmod 644 /usr/share/fonts/truetype/canopypdffonts/*
